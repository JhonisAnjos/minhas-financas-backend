...
import br.com.api.dto.AtualizarStatusDTO;
import br.com.api.dto.LancamentoDTO;
	...
	public ResponseEntity<?> atualizarStatus(@PathVariable("id") Long id, @RequestBody AtualizarStatusDTO dto){
		return service.obterPorId(id).map(entity -> {
			...
			if(statusSelecionado == null) {
				return new ResponseEntity("Não foi possivel atualizar o status do lançamento, envie um status válido.", HttpStatus.BAD_REQUEST);
			}else {
				try {
